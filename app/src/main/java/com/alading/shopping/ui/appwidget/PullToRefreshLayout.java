...
public class PullToRefreshLayout extends RelativeLayout {
	...
	private Animation noDataAnimation;
	...
	private void initView(Context context) {
		...
		noDataAnimation =  AnimationUtils.loadAnimation(context, R.anim.exception_tip);
		// 添加匀速转动动画
	...
	public void loadmoreFinish(int refreshResult) {
		...
		case NOMORE:
			...
			loadStateImageView.setVisibility(View.VISIBLE);
			loadStateTextView.setText(R.string.load_no);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		loadmoreView.layout(0, (int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight(),
				loadmoreView.getMeasuredWidth(), (int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight()
