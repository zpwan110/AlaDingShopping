...
public class ProgressWheel extends View {
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            // circle
            int minValue = Math.min(layout_width - paddingLeft - paddingRight, layout_height - paddingBottom
                    - paddingTop);
            ...
            circleBounds = new RectF(paddingLeft + barWidth, paddingTop + barWidth, layout_width - paddingRight
                    - barWidth, layout_height - paddingBottom - barWidth);
        }
    }
