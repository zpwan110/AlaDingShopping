 ...
 */
package com.alading.library.util.download;
...
import com.alading.library.util.http.FileHttpResponseHandler;
...
public class DownloadManager extends Thread
{
			...
			throws MalformedURLException
	{
				...
				rootPath, TAStringUtils.getFileNameFromUrl(url))
		{
			...
			@Override
			public void onFailure(String requset,Throwable error)
			{
				// TODO Auto-generated method stub
