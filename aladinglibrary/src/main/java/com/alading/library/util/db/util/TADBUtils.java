...
import com.alading.library.common.TAStringUtils;
import com.alading.library.exception.TADBException;
import com.alading.library.util.db.annotation.TAColumn;
import com.alading.library.util.db.annotation.TAPrimaryKey;
import com.alading.library.util.db.annotation.TATableName;
import com.alading.library.util.db.annotation.TATransient;
import com.alading.library.util.db.entity.TAHashMap;
import com.alading.library.util.db.entity.TAPKProperyEntity;
import com.alading.library.util.db.entity.TAPropertyEntity;
import com.alading.library.util.db.entity.TATableInfoEntity;

import android.database.Cursor;

/**
 * @Title TASqlBuilder
 * @Package com.alading.library.util.db.util.sql
