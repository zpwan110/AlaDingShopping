...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    @Override
    protected void sendSuccessMessage(String requset,int statusCode, String responseBody) {
        if (statusCode != HttpStatus.SC_NO_CONTENT){        
            try {
                Object jsonResponse = parseResponse(responseBody);
	        sendMessage(obtainMessage(SUCCESS_JSON_MESSAGE, new Object[]{requset,statusCode, jsonResponse}));
    	    } catch(JSONException e) {
    	        sendFailureMessage(e, responseBody,requset);
    	    }
        } else {
            sendMessage(obtainMessage(SUCCESS_JSON_MESSAGE, new Object[]{requset,statusCode, new JSONObject()}));
    	}
    }
    ...
    @Override
    protected void handleFailureMessage(String requset,Throwable e, String responseBody) {
        try {
