...
import com.alading.library.util.http.AsyncHttpRequest;
...
public class TASyncHttpClient extends AsyncHttpClient
{
	...
	protected AsyncHttpResponseHandler responseHandler = new AsyncHttpResponseHandler()
	{
		...
		@Override
		protected void sendResponseMessage(org.apache.http.HttpResponse response,String requset)
		{
			responseCode = response.getStatusLine().getStatusCode();
			super.sendResponseMessage(response,requset);
		}
		...
		@Override
		public void onSuccess(String requset,String content)
		{
			result = content;
		}

		@Override
		public void onFailure(String requset,Throwable error, String content)
		{
